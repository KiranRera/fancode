...
public class FancodeTest extends TestBase {
	...
	public void TaskCompletedMoreThan50PercentTest() {
        ...
        Assert.assertEquals(StatusCodeEnum.Code_200.getCode(), userResponse.getStatusCode(), "Response Failed");
		...
		for (User user : usersArray) {
			...
			if (TestHelper.LatituteLongitudeCheckerForUser(userLat, userLng)) {
                ...
                Assert.assertEquals(StatusCodeEnum.Code_200.getCode(), todoResponse.getStatusCode(), "Response Failed");
